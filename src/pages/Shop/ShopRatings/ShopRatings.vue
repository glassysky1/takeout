        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0?'icon-search':'icon-dingdan'"></span>
  ...
  computed: {
    ...
    filterRatings(){
      ...
      return ratings.filter(rating =>{
        //从每个评论中找出rateType和text进行匹配然后过滤
        //selectType和onlyShowtext是点击事件留下的数值与rateType和text一一对应
        ...
        /* 
          条件1:
            ...
            若果为全部或者(满意并且大拇指价/不满意并且小拇指)
          条件2：
            onlyShowText:true/false
            text:有值/没值
            !onlyShowText || text.lengtth>0
            !onlyShowText || onlyShowText&&text.length>0
        */
